...
//			paint.setFakeBoldText(true);
			...
			paint.setTextSize(Global.Device.getScreenHeight(getContext())*17/800);
			if (i == choose) {
				paint.setColor(Color.parseColor("#f34a3f"));
			}
	...
	private void showPopup(int item) {
		...
		if (mPopupWindow == null) {
			...
			mPopupText.setBackgroundResource(R.drawable.circle_bg);
//			mPopupText.setBackgroundColor(Color.parseColor("#f34a3f"));
			mPopupText.setTextColor(Color.WHITE);
			mPopupText.setTextSize(50);
			int h = Global.Device.getScreenHeight(getContext())*100/800;
			mPopupText.setWidth(h);
			mPopupText.setHeight(h);
